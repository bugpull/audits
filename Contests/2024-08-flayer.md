...
## [H-01] User Initializing a Pool will have his funds stuck, By [**Hunter**](https://github.com/IlIlHunterlIlI)
...
## [H-02] `Listings::reserve()` doesn't delete reserved listings causing integration issue, By [**Hunter**](https://github.com/IlIlHunterlIlI)
...
## [H-03] Voters lose their tokens due to misconfiguration in `cancel` function, By [**Rzizah**](https://github.com/rzizah)
...
## [H-04] Owner of Bridged ERC1155 Royalties can't claim them, By [**Hunter**](https://github.com/IlIlHunterlIlI)
...
## [H-05] relisting previously liquidated NFT will cause loss of funds to new owner, By [**Hunter**](https://github.com/IlIlHunterlIlI)
...
## [H-06] Malicious Whale can cause Loss of Fees of LP Providers, By [**Hunter**](https://github.com/IlIlHunterlIlI)
...
## [H-07] Attacker can frontrun large fee deposits from `fillListing`, By [**Hunter**](https://github.com/IlIlHunterlIlI)
...
## [H-08] reserving a previously liquidated Token will cause loss of funds to new owner, By [**Hunter**](https://github.com/IlIlHunterlIlI)
...
## [M-01] Malicious user can bypass execution of `CollectionShutdown` function, By [**Rzizah**](https://github.com/rzizah)
...
## [M-02] User extra funds during Pool initializtion would be stuck in `UniswapImplementation`, By [**Hunter**](https://github.com/IlIlHunterlIlI)
...
## [M-03] Broken core contract functionality `UniswapImplementation::setFeeExemption` making `exemptionFee` is never useable, By [**Rzizah**](https://github.com/rzizah)
...
## [M-04] EdgeCase in `CollectionShutdown` leading to funds being stuck, By [**Rzizah**](https://github.com/rzizah)
...
## [M-05] Malicious user can prevent `lockerManager` from executing `CollectionShutdown` function, By [**Rzizah**](https://github.com/rzizah)
...
## [M-06] Malicious Whale can manipulate `totalsupply` to liquidate or illiquidate a liqudiateable listing, By [**Hunter**](https://github.com/IlIlHunterlIlI) and [**Rzizah**](https://github.com/rzizah)
